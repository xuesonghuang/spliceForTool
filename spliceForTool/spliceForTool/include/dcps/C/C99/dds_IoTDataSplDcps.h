...
extern C99_BUILTIN v_copyin_result __DDS_IoT_IoTNVP__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_IoT_IoTNVP__copyOut(const void *_from, void *_to);
struct _DDS_IoT_IoTNVP {
    c_string name;
...
extern C99_BUILTIN v_copyin_result __DDS_IoT_IoTData__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_IoT_IoTData__copyOut(const void *_from, void *_to);
struct _DDS_IoT_IoTData {
    c_string typeName;
    c_string instanceId;
