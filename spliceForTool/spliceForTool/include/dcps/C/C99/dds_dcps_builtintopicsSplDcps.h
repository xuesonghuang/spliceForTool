...
struct _DDS_Time_t ;
extern C99_BUILTIN v_copyin_result __DDS_Time_t__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_Time_t__copyOut(const void *_from, void *_to);
struct _DDS_Time_t {
    c_long sec;
    c_ulong nanosec;
};
...
extern C99_BUILTIN v_copyin_result __DDS_SchedulingClassQosPolicy__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_SchedulingClassQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_SchedulingClassQosPolicy {
...
extern C99_BUILTIN v_copyin_result __DDS_SchedulingPriorityQosPolicy__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_SchedulingPriorityQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_SchedulingPriorityQosPolicy {
...
extern C99_BUILTIN v_copyin_result __DDS_SchedulingQosPolicy__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_SchedulingQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_SchedulingQosPolicy {
...
extern C99_BUILTIN v_copyin_result __DDS_ViewKeyQosPolicy__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_ViewKeyQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_ViewKeyQosPolicy {
    c_bool use_key_list;
...
extern C99_BUILTIN v_copyin_result __DDS_DataReaderViewQos__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_DataReaderViewQos__copyOut(const void *_from, void *_to);
struct _DDS_DataReaderViewQos {
...
extern C99_BUILTIN v_copyin_result __DDS_DomainParticipantFactoryQos__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_DomainParticipantFactoryQos__copyOut(const void *_from, void *_to);
struct _DDS_DomainParticipantFactoryQos {
...
extern C99_BUILTIN v_copyin_result __DDS_DomainParticipantQos__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_DomainParticipantQos__copyOut(const void *_from, void *_to);
struct _DDS_DomainParticipantQos {
...
extern C99_BUILTIN v_copyin_result __DDS_TopicQos__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_TopicQos__copyOut(const void *_from, void *_to);
struct _DDS_TopicQos {
...
extern C99_BUILTIN v_copyin_result __DDS_DataWriterQos__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_DataWriterQos__copyOut(const void *_from, void *_to);
struct _DDS_DataWriterQos {
    struct _DDS_DurabilityQosPolicy durability;
    struct _DDS_DeadlineQosPolicy deadline;
    struct _DDS_LatencyBudgetQosPolicy latency_budget;
...
extern C99_BUILTIN v_copyin_result __DDS_PublisherQos__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_PublisherQos__copyOut(const void *_from, void *_to);
struct _DDS_PublisherQos {
...
extern C99_BUILTIN v_copyin_result __DDS_DataReaderQos__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_DataReaderQos__copyOut(const void *_from, void *_to);
struct _DDS_DataReaderQos {
    struct _DDS_DurabilityQosPolicy durability;
    struct _DDS_DeadlineQosPolicy deadline;
    struct _DDS_LatencyBudgetQosPolicy latency_budget;
...
extern C99_BUILTIN v_copyin_result __DDS_SubscriberQos__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_SubscriberQos__copyOut(const void *_from, void *_to);
struct _DDS_SubscriberQos {
    struct _DDS_PresentationQosPolicy presentation;
    struct _DDS_PartitionQosPolicy partition;
    struct _DDS_GroupDataQosPolicy group_data;
