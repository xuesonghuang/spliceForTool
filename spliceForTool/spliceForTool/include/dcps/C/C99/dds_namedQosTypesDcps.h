...
C99_BUILTIN DDS_NamedDomainParticipantQos *DDS_NamedDomainParticipantQos__alloc (void);
...
C99_BUILTIN DDS_NamedPublisherQos *DDS_NamedPublisherQos__alloc (void);
...
C99_BUILTIN DDS_NamedSubscriberQos *DDS_NamedSubscriberQos__alloc (void);
...
C99_BUILTIN DDS_NamedTopicQos *DDS_NamedTopicQos__alloc (void);
...
C99_BUILTIN DDS_NamedDataWriterQos *DDS_NamedDataWriterQos__alloc (void);
...
C99_BUILTIN DDS_NamedDataReaderQos *DDS_NamedDataReaderQos__alloc (void);
