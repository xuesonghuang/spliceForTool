...
C99_BUILTIN extern const dds_topic_descriptor_t DDS_String_desc;


#define DDS_String_free(d,o) dds_sample_free ((d), &DDS_String_desc, (o))


C99_BUILTIN extern const dds_topic_descriptor_t DDS_KeyedString_desc;


#define DDS_KeyedString_free(d,o) dds_sample_free ((d), &DDS_KeyedString_desc, (o))


C99_BUILTIN extern const dds_topic_descriptor_t DDS_Bytes_desc;


#define DDS_Bytes_free(d,o) dds_sample_free ((d), &DDS_Bytes_desc, (o))


C99_BUILTIN extern const dds_topic_descriptor_t DDS_KeyedBytes_desc;
