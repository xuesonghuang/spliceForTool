...
namespace DDS {
    ...
    class OS_API CDRSampleTypeSupportMetaHolder : public ::DDS::OpenSplice::TypeSupportMetaHolder
    {
    public:
    ...
    class OS_API CDRSampleTypeSupport : public virtual CDRSampleTypeSupportInterface,
    ...
    class OS_API CDRSampleDataWriter_impl : public virtual CDRSampleDataWriter,
    ...
    class OS_API CDRSampleDataReader_impl : public virtual CDRSampleDataReader,
    ...
    class OS_API CDRSampleDataReaderView_impl : public virtual CDRSampleDataReaderView,
