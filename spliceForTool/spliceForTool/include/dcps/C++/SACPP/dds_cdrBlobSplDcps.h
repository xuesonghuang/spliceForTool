...
extern OS_API v_copyin_result __DDS_CDRSample__copyIn(c_base base, const struct DDS::CDRSample *from, struct _DDS_CDRSample *to);
extern OS_API void __DDS_CDRSample__copyOut(const void *_from, void *_to);
struct _DDS_CDRSample {
    _DDS_CDRBlob blob;
};
