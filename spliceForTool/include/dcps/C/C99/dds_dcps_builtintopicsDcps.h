...
C99_BUILTIN DDS_Time_t *DDS_Time_t__alloc (void);
...
C99_BUILTIN DDS_SchedulingClassQosPolicy *DDS_SchedulingClassQosPolicy__alloc (void);
...
C99_BUILTIN DDS_SchedulingPriorityQosPolicy *DDS_SchedulingPriorityQosPolicy__alloc (void);
...
C99_BUILTIN DDS_SchedulingQosPolicy *DDS_SchedulingQosPolicy__alloc (void);
...
C99_BUILTIN DDS_ViewKeyQosPolicy *DDS_ViewKeyQosPolicy__alloc (void);
...
C99_BUILTIN DDS_DataReaderViewQos *DDS_DataReaderViewQos__alloc (void);
...
C99_BUILTIN DDS_DomainParticipantFactoryQos *DDS_DomainParticipantFactoryQos__alloc (void);
...
C99_BUILTIN DDS_DomainParticipantQos *DDS_DomainParticipantQos__alloc (void);
...
C99_BUILTIN DDS_TopicQos *DDS_TopicQos__alloc (void);
...
C99_BUILTIN DDS_DataWriterQos *DDS_DataWriterQos__alloc (void);
...
C99_BUILTIN DDS_PublisherQos *DDS_PublisherQos__alloc (void);
...
C99_BUILTIN DDS_DataReaderQos *DDS_DataReaderQos__alloc (void);
...
C99_BUILTIN DDS_SubscriberQos *DDS_SubscriberQos__alloc (void);
