...
extern C99_BUILTIN v_copyin_result __DDS_NamedDomainParticipantQos__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_NamedDomainParticipantQos__copyOut(const void *_from, void *_to);
struct _DDS_NamedDomainParticipantQos {
    c_string name;
...
extern C99_BUILTIN v_copyin_result __DDS_NamedPublisherQos__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_NamedPublisherQos__copyOut(const void *_from, void *_to);
struct _DDS_NamedPublisherQos {
    c_string name;
...
extern C99_BUILTIN v_copyin_result __DDS_NamedSubscriberQos__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_NamedSubscriberQos__copyOut(const void *_from, void *_to);
struct _DDS_NamedSubscriberQos {
    c_string name;
...
extern C99_BUILTIN v_copyin_result __DDS_NamedTopicQos__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_NamedTopicQos__copyOut(const void *_from, void *_to);
struct _DDS_NamedTopicQos {
    c_string name;
...
extern C99_BUILTIN v_copyin_result __DDS_NamedDataWriterQos__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_NamedDataWriterQos__copyOut(const void *_from, void *_to);
struct _DDS_NamedDataWriterQos {
    c_string name;
...
extern C99_BUILTIN v_copyin_result __DDS_NamedDataReaderQos__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_NamedDataReaderQos__copyOut(const void *_from, void *_to);
struct _DDS_NamedDataReaderQos {
    c_string name;
