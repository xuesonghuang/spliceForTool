...
C99_BUILTIN DDS_octSeq *DDS_octSeq__alloc (void);
C99_BUILTIN uint8_t *DDS_octSeq_allocbuf (uint32_t len);

typedef int32_t DDS_BuiltinTopicKey_t[3];
typedef int32_t DDS_BuiltinTopicKey_t_slice;
C99_BUILTIN DDS_BuiltinTopicKey_t_slice *DDS_BuiltinTopicKey_t__alloc (void);
...
C99_BUILTIN DDS_StringSeq *DDS_StringSeq__alloc (void);
C99_BUILTIN char * *DDS_StringSeq_allocbuf (uint32_t len);

typedef int16_t DDS_DataRepresentationId_t;
C99_BUILTIN DDS_DataRepresentationId_t *DDS_DataRepresentationId_t__alloc (void);
...
C99_BUILTIN DDS_Duration_t *DDS_Duration_t__alloc (void);
...
C99_BUILTIN DDS_UserDataQosPolicy *DDS_UserDataQosPolicy__alloc (void);
...
C99_BUILTIN DDS_TopicDataQosPolicy *DDS_TopicDataQosPolicy__alloc (void);
...
C99_BUILTIN DDS_GroupDataQosPolicy *DDS_GroupDataQosPolicy__alloc (void);
...
C99_BUILTIN DDS_TransportPriorityQosPolicy *DDS_TransportPriorityQosPolicy__alloc (void);
...
C99_BUILTIN DDS_LifespanQosPolicy *DDS_LifespanQosPolicy__alloc (void);
...
C99_BUILTIN DDS_DurabilityQosPolicy *DDS_DurabilityQosPolicy__alloc (void);
...
C99_BUILTIN DDS_PresentationQosPolicy *DDS_PresentationQosPolicy__alloc (void);
...
C99_BUILTIN DDS_DeadlineQosPolicy *DDS_DeadlineQosPolicy__alloc (void);
...
C99_BUILTIN DDS_LatencyBudgetQosPolicy *DDS_LatencyBudgetQosPolicy__alloc (void);
...
C99_BUILTIN DDS_OwnershipQosPolicy *DDS_OwnershipQosPolicy__alloc (void);
...
C99_BUILTIN DDS_OwnershipStrengthQosPolicy *DDS_OwnershipStrengthQosPolicy__alloc (void);
...
C99_BUILTIN DDS_LivelinessQosPolicy *DDS_LivelinessQosPolicy__alloc (void);
...
C99_BUILTIN DDS_TimeBasedFilterQosPolicy *DDS_TimeBasedFilterQosPolicy__alloc (void);
...
C99_BUILTIN DDS_PartitionQosPolicy *DDS_PartitionQosPolicy__alloc (void);
...
C99_BUILTIN DDS_ReliabilityQosPolicy *DDS_ReliabilityQosPolicy__alloc (void);
...
C99_BUILTIN DDS_DestinationOrderQosPolicy *DDS_DestinationOrderQosPolicy__alloc (void);
...
C99_BUILTIN DDS_HistoryQosPolicy *DDS_HistoryQosPolicy__alloc (void);
...
C99_BUILTIN DDS_ResourceLimitsQosPolicy *DDS_ResourceLimitsQosPolicy__alloc (void);
...
C99_BUILTIN DDS_DurabilityServiceQosPolicy *DDS_DurabilityServiceQosPolicy__alloc (void);
...
C99_BUILTIN DDS_ProductDataQosPolicy *DDS_ProductDataQosPolicy__alloc (void);
...
C99_BUILTIN DDS_EntityFactoryQosPolicy *DDS_EntityFactoryQosPolicy__alloc (void);
...
C99_BUILTIN DDS_ShareQosPolicy *DDS_ShareQosPolicy__alloc (void);
...
C99_BUILTIN DDS_WriterDataLifecycleQosPolicy *DDS_WriterDataLifecycleQosPolicy__alloc (void);
...
C99_BUILTIN DDS_InvalidSampleVisibilityQosPolicy *DDS_InvalidSampleVisibilityQosPolicy__alloc (void);
...
C99_BUILTIN DDS_SubscriptionKeyQosPolicy *DDS_SubscriptionKeyQosPolicy__alloc (void);
...
C99_BUILTIN DDS_ReaderDataLifecycleQosPolicy *DDS_ReaderDataLifecycleQosPolicy__alloc (void);
...
C99_BUILTIN DDS_UserKeyQosPolicy *DDS_UserKeyQosPolicy__alloc (void);
...
C99_BUILTIN DDS_ReaderLifespanQosPolicy *DDS_ReaderLifespanQosPolicy__alloc (void);
...
C99_BUILTIN DDS_TypeHash *DDS_TypeHash__alloc (void);
...
C99_BUILTIN DDS_ParticipantBuiltinTopicData *DDS_ParticipantBuiltinTopicData__alloc (void);
...
C99_BUILTIN DDS_TopicBuiltinTopicData *DDS_TopicBuiltinTopicData__alloc (void);
...
C99_BUILTIN DDS_TypeBuiltinTopicData *DDS_TypeBuiltinTopicData__alloc (void);
...
C99_BUILTIN DDS_PublicationBuiltinTopicData *DDS_PublicationBuiltinTopicData__alloc (void);
...
C99_BUILTIN DDS_SubscriptionBuiltinTopicData *DDS_SubscriptionBuiltinTopicData__alloc (void);
...
C99_BUILTIN DDS_CMParticipantBuiltinTopicData *DDS_CMParticipantBuiltinTopicData__alloc (void);
...
C99_BUILTIN DDS_CMPublisherBuiltinTopicData *DDS_CMPublisherBuiltinTopicData__alloc (void);
...
C99_BUILTIN DDS_CMSubscriberBuiltinTopicData *DDS_CMSubscriberBuiltinTopicData__alloc (void);
...
C99_BUILTIN DDS_CMDataWriterBuiltinTopicData *DDS_CMDataWriterBuiltinTopicData__alloc (void);
...
C99_BUILTIN DDS_CMDataReaderBuiltinTopicData *DDS_CMDataReaderBuiltinTopicData__alloc (void);
