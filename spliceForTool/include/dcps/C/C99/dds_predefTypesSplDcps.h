...
struct _DDS_String ;
extern C99_BUILTIN v_copyin_result __DDS_String__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_String__copyOut(const void *_from, void *_to);
struct _DDS_String {
    c_string value;
};
...
extern C99_BUILTIN v_copyin_result __DDS_KeyedString__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_KeyedString__copyOut(const void *_from, void *_to);
struct _DDS_KeyedString {
    c_string key;
    c_string value;
};
...
struct _DDS_Bytes ;
extern C99_BUILTIN v_copyin_result __DDS_Bytes__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_Bytes__copyOut(const void *_from, void *_to);
struct _DDS_Bytes {
    _DDS_ByteSeq value;
};
...
extern C99_BUILTIN v_copyin_result __DDS_KeyedBytes__copyIn(c_base base, const void *from, void *to);
extern C99_BUILTIN void __DDS_KeyedBytes__copyOut(const void *_from, void *_to);
struct _DDS_KeyedBytes {
    c_string key;
    _DDS_ByteSeq value;
};
