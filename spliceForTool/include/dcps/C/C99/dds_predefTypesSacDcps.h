...
C99_BUILTIN DDS_StringTypeSupport
...
C99_BUILTIN DDS_sequence_DDS_String *DDS_sequence_DDS_String__alloc (void);
C99_BUILTIN DDS_String *DDS_sequence_DDS_String_allocbuf (DDS_unsigned_long len);
...
C99_BUILTIN DDS_KeyedStringTypeSupport
...
C99_BUILTIN DDS_sequence_DDS_KeyedString *DDS_sequence_DDS_KeyedString__alloc (void);
C99_BUILTIN DDS_KeyedString *DDS_sequence_DDS_KeyedString_allocbuf (DDS_unsigned_long len);
...
C99_BUILTIN DDS_BytesTypeSupport
...
C99_BUILTIN DDS_sequence_DDS_Bytes *DDS_sequence_DDS_Bytes__alloc (void);
C99_BUILTIN DDS_Bytes *DDS_sequence_DDS_Bytes_allocbuf (DDS_unsigned_long len);
...
C99_BUILTIN DDS_KeyedBytesTypeSupport
...
C99_BUILTIN DDS_sequence_DDS_KeyedBytes *DDS_sequence_DDS_KeyedBytes__alloc (void);
C99_BUILTIN DDS_KeyedBytes *DDS_sequence_DDS_KeyedBytes_allocbuf (DDS_unsigned_long len);
