...
C99_BUILTIN DDS_IoT_IoTDataTypeSupport
...
C99_BUILTIN DDS_sequence_DDS_IoT_IoTData *DDS_sequence_DDS_IoT_IoTData__alloc (void);
C99_BUILTIN DDS_IoT_IoTData *DDS_sequence_DDS_IoT_IoTData_allocbuf (DDS_unsigned_long len);
